...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ex_3  - Otavio", nullptr, nullptr);
	...
	float veloc = 0.007;
	float velocx = veloc, velocy = veloc*1.5;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//std::cout << model[4].x << std::endl << "\n";

		model = glm::translate(model, glm::vec3(velocx, velocy, 0));
